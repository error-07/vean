...
export function ServiceStatus() {
  ...
  return (
    <div className="flex flex-col w-full bg-zinc-950 min-h-screen text-zinc-50">
      <Navbar />
      <div className="pt-14">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-12 w-full py-16 sm:py-24">
          <div className="flex flex-col items-start mb-10 sm:mb-12">
            ...
            >
              Network <span className="text-blue-400">Status</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 sm:p-8 mb-10 sm:mb-12 flex items-center gap-6"
          >
            <div className="bg-blue-400/20 p-4 rounded-full shrink-0">
              <Activity className="text-blue-400" size={32} />
            </div>
            <div>
              <h2 className="text-xl sm:text-2xl font-bold mb-1">All Systems Operational</h2>
              <p className="text-zinc-400 text-sm sm:text-base">
                Our core network is currently running normally with no major outages reported.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="divide-y divide-zinc-800">
              {regions.map((region, i) => (
                <div
                  key={i}
                  className="p-5 sm:p-6 flex items-center justify-between hover:bg-zinc-800/50 transition-colors"
                >
                  <span className="font-medium text-base sm:text-lg">{region.name}</span>
