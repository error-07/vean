...
export function Help() {
  ...
  return (
    <div className="flex flex-col w-full bg-zinc-950 text-zinc-50 min-h-screen">
      <Navbar />
      <div className="pt-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 w-full py-16 sm:py-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16">
            ...
            >
              ...
              <div className="bg-blue-400 text-zinc-950 p-8 rounded-3xl flex items-center gap-6 hover:bg-blue-500 transition-colors cursor-pointer group">
                <div className="bg-zinc-950 text-blue-400 p-4 rounded-full group-hover:scale-110 transition-transform shrink-0">
              ...
              <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-3xl flex items-center gap-6 hover:bg-zinc-800 transition-colors cursor-pointer group">
                <div className="bg-zinc-950 text-white border border-zinc-800 p-4 rounded-full group-hover:scale-110 transition-transform shrink-0">
                  <Phone size={28} />
                </div>
                <div>
