...
export function Home() {
  ...
  return (
    <>
      ...
      {/* ── Hero Section ── */}
      {/* pt-24 accounts for the two fixed bars (~96px total) */}
      <section className="relative px-4 sm:px-6 md:px-12 pt-24 pb-20 max-w-7xl mx-auto w-full z-10">
        {/* Gradient Blob */}
        <div
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
          ...
          >
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-2xl hover:border-blue-500/30 transition-colors">
              ...
              {status === "searching" && (
                <p className="text-blue-400 font-bold text-sm mb-2 animate-pulse">Checking availability...</p>
              )}
      ...
      {/* ── Plans Section ── */}
      <section className="py-20 sm:py-28 px-4 sm:px-6 md:px-12 rounded-t-[3rem] mt-10 relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-800">
